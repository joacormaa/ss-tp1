...
particleRadius = 1
particleRC = 1
frontierRadius = particleRadius + particleRC
focusId = 696
...
p.circle(myX, myY, radius=particleRadius, color="navy", alpha=0.5)
r = p.circle([focusX],  [focusY], radius=particleRadius, color="black", alpha=0.5)
glyph = r.glyph
glyph.radius = frontierRadius
glyph.fill_alpha = 0.2
glyph.line_color = "firebrick"
glyph.line_dash = [6, 3]
glyph.line_width = 2

p.circle(focusNeighborsX, focusNeighborsY, radius=particleRadius, color="black", alpha=0.5)
