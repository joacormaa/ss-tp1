...
public class GasSystemCreator {
    ...
    private static List<StaticParticle> initializeStaticParticles() {
        ...
        staticParticles.add(new StaticParticle(4, c.VERTICAL_WALL_LENGTH(), 0, 0 ));
        staticParticles.add(new StaticParticle(5, c.VERTICAL_WALL_LENGTH(), c.HORIZONTAL_WALL_LENGTH(), 0 ));
